...
Sampling-based model fitting utilities with likelihoods estimated via inverse binomial sampling ([van Opheusden, Acerbi & Ma, 2020](https://doi.org/10.1371/journal.pcbi.1008483)).

- **`mfit.ibs.ibs_ll`**: unbiased log-likelihood estimation via IBS
