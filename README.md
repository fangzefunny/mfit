...
- **`mfit.fit.fit`** / **`mfit.fit.fit_single`**: given a likelihood, fit parameters (`"Nelder-Mead"`, `"BFGS"`, `"bads"`: [Acerbi & Ma, 2017](https://doi.org/10.48550/arXiv.1705.04405))
- **`mfit.fit.fit_parallel`**: parallel multi-start wrapper around `fit`
